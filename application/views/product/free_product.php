		...
		<div>
			...
			<?php  if($offer['discount_offer_price'] != 0) {?>
				<div class="sc-pricing">
					<span class="pricing-new"><span data-product_price="<?php echo $offer['discount_offer_price'];?>" id="price_label">0.00</spanid>€</span>
					<span class="pricing-old"><?php echo $this->lang->line('cost'); ?> <span><?php echo $offer['offer_price'];?></span>€</span>
				</div>
				<div class="sc-dctxt">
					<?php echo $this->lang->line('save_now'); ?> <span>(100%)</span>
				</div>
			<?php } else { ?>
				<div class="sc-pricing">
					<span class="pricing-new"><span data-product_price="<?php echo $offer['discount_offer_price'];?>" id="price_label">0.00</span>€</span>
				</div>
			<?php } ?>
